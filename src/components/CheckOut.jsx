          ...
          <div className="col-span-6 bg-white">
            ...
            {product &&
                    ...
                    <div className="grid grid-cols-12 divide-y divide-gray-400 mr-4">
                      <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400">
                        ...
                        <div className="col-span-6">
                          ...
                          <div>
                            <button className="text-sm xl:text-base font-semibold rounded text-blue-500 mt-2 mb-1" onClick={() => dispatch(removeFromCart(product.id))}>Remove</button>
                          </div>
              ...
              <div className="text-lg xl:text-xl text-right mb-4 mr-4">
                Subtotal ({itemsNumber === 1 || itemsNumber === 0 ? `${itemsNumber} item` : `${itemsNumber} items`} ): <span className="font-semibold">{GB_CURRENCY.format(subtotal)}</span>
              </div>
          </div>
          {/* Checkout */}
